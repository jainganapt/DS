...
public final class finalclassex {
	...
	/*
	 * public finalclassex(int i, String n, HashMap<String,String> hm){
	 * System.out.println("Performing Deep  for Object initialization"); this.id=i;
	 * this.name=n; HashMap<String,String> tempMap=new HashMap<String,String>();
	...
	public static void main(String[] args) {
		...
		finalclassex ce = new finalclassex(i,s,h1);
